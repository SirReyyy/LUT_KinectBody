...
public class VfxGestureListener : MonoBehaviour, KinectGestures.GestureListenerInterface
{
    ...
    private static VfxGestureListener instance = null;
    ...
    public static VfxGestureListener Instance
    {
        get
        {
            return instance;
